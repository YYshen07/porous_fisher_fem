...
PARAMS = [ 
    ...
    struct('Lx',40,'Ly',40,'afr',0.4,'iflag',1), ...
    struct('Lx',40,'Ly',40,'afr',0.2,'iflag',1), ...
    struct('Lx',40,'Ly',40,'afr',0.07,'iflag',1), ...
    struct('Lx',60,'Ly',60,'afr',0.4,'iflag',1), ...
    struct('Lx',60,'Ly',60,'afr',0.2,'iflag',1), ...
    struct('Lx',60,'Ly',60,'afr',0.07,'iflag',1), ...
    struct('Lx',80,'Ly',80,'afr',0.4,'iflag',1), ...
    struct('Lx',80,'Ly',80,'afr',0.2,'iflag',1), ...
    struct('Lx',80,'Ly',80,'afr',0.07,'iflag',1)
];


max_inum  = 40000;   % 最大时间步
